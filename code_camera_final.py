...
st.set_page_config(page_title="Code Camera", layout="wide")
...
st.subheader("📁 Upload Code Photos (Batch OK - Recommended)")
uploaded_files = st.file_uploader("Drop photos of code here", type=["jpg", "png", "jpeg"], accept_multiple_files=True)

st.subheader("📸 Live Camera (if available)")
camera_photo = st.camera_input("Take photo of code")
...
st.info("✅ Upload works best. Camera may need browser permission. Files saved in current folder.")
